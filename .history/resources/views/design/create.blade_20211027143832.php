...
<div class="col-lg-11 ml-4 mt-3 mb-3">
    ...
    <div class="form-group">
        ...
        <input class="form-control" list="browsers" id="style" name="style">
        <datalist name="style" id="browsers">
        <option class="form-control" value="Baju Melayu Cekak Musang"> 
        <option class="form-control" value="Baju Melayu Teluk Belanga">
      </datalist> 
    </div>
