...
<div class="col-lg-11 ml-4 mt-3 mb-3">
    ...
    <div class="form-group">
        ...
        <input class="col-sm-6 custom-select custom-select-sm @error('style') is-invalid @enderror" list="browsers" id="style" name="style" autocomplete="off">
        <datalist class="@error('style') is-invalid @enderror" 
